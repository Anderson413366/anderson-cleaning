        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <a href="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-gray-900">Anderson Cleaning</span>
            </a>
            <div className="flex items-center space-x-4">
              <a href="/services" className="text-gray-700 hover:text-primary-700">← All Services</a>
              <Button variant="primary" size="sm" onClick={() => window.location.href='/quote'}>Get a Quote</Button>
            </div>
          </div>
        </div>
      </header>
