/**
 * i18next Translation Resources for Careers Application
 * Scoped to /apply route only
 * Supports: en, es, pt-BR, ro
 */
...
export const resources = {
  en: {
    translation: {
      ...
      submissionErrorMessage: "An error occurred while submitting your application. Please check your internet connection and try again.",
  ...
  es: {
    translation: {
      ...
      // Hero Section
      heroTitle: "Únete a Nuestro Equipo en Anderson Cleaning",
      heroSubtitle: "Descubre emocionantes oportunidades de carrera y crece con una empresa que valora la dedicación y la excelencia.",
      ...
      submissionSuccessMessage: "¡Gracias por aplicar! Hemos recibido su solicitud y nos pondremos en contacto si sus calificaciones cumplen con nuestras necesidades.",
      submissionErrorTitle: "Error de Envío",
      submissionErrorMessage: "Ocurrió un error al enviar su solicitud. Por favor, verifique su conexión a internet e intente nuevamente.",
  ...
  'pt-BR': {
    translation: {
      ...
      submittingButton: "Enviando, por favor aguarde...",
      ...
      zipCodeLabel: "CEP/Código Postal",
      ...
      submissionSuccessMessage: "Obrigado por se candidatar! Recebemos sua candidatura e entraremos em contato se suas qualificações atenderem às nossas necessidades.",
      submissionErrorTitle: "Erro de Envio",
      submissionErrorMessage: "Ocorreu um erro ao enviar sua candidatura. Por favor, verifique sua conexão com a internet e tente novamente.",
  ...
  ro: {
    translation: {
      ...
      heroSubtitle: "Descoperă oportunități de carieră interesante și crește împreună cu o companie care prețuiește dedicarea și excelența.",
      ...
      // Messages
      incompleteSectionError: "Vă rugăm să completați toate câmpurile obligatorii (*) din secțiunea curentă înainte de a continua.",
      submissionSuccessTitle: "Aplicație trimisă!",
      submissionSuccessMessage: "Vă mulțumim că ați aplicat! Am primit aplicația dvs. și vă vom contacta dacă calificările dvs. corespund nevoilor noastre.",
      submissionErrorTitle: "Eroare la trimitere",
      submissionErrorMessage: "A apărut o eroare la trimiterea aplicației dvs. Vă rugăm să verificați conexiunea la internet și să încercați din nou.",
