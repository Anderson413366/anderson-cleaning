...
export default function SupplyManagementPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 transition-colors duration-300">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-brand-deep-blue to-brand-bright-blue text-white">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-br from-brand-deep-blue to-brand-bright-blue text-white">
