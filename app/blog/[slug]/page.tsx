    ...
    <div className="min-h-screen bg-neutral-off-white dark:bg-slate-900">
      ...
      <article className="pt-12 pb-12">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap items-center gap-6 text-neutral-charcoal/70 dark:text-white/80 mb-8">
              ...
              <div className="flex items-center gap-2">
                <div className="h-10 w-10 rounded-full bg-gradient-to-br from-brand-deep-blue to-brand-bright-blue flex items-center justify-center text-white font-bold text-sm">
                  AC
                </div>
            ...
            {/* Share Buttons */}
            <div className="flex flex-wrap items-center gap-3 pb-8 border-b border-neutral-light-grey dark:border-slate-700">
              <span className="text-sm font-medium text-neutral-charcoal/80 dark:text-white/80">Share:</span>

              {/* LinkedIn */}
              <a
                href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://andersoncleaning.com/blog/${slug}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg hover:bg-neutral-light-grey dark:hover:bg-slate-800 transition-colors group"
                aria-label="Share on LinkedIn"
              >
                <svg className="h-5 w-5 text-neutral-charcoal/70 dark:text-white/80 group-hover:text-[#0077B5]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* Facebook */}
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://andersoncleaning.com/blog/${slug}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg hover:bg-neutral-light-grey dark:hover:bg-slate-800 transition-colors group"
                aria-label="Share on Facebook"
              >
                <svg className="h-5 w-5 text-neutral-charcoal/70 dark:text-white/80 group-hover:text-[#1877F2]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* X (Twitter) */}
              <a
                href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://andersoncleaning.com/blog/${slug}`)}&text=${encodeURIComponent(post.title)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg hover:bg-neutral-light-grey dark:hover:bg-slate-800 transition-colors group"
                aria-label="Share on X"
              >
                <svg className="h-5 w-5 text-neutral-charcoal/70 dark:text-white/80 group-hover:text-[#000000] dark:group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* Email */}
              <a
                href={`mailto:?subject=${encodeURIComponent(post.title)}&body=${encodeURIComponent(`Check out this article: https://andersoncleaning.com/blog/${slug}`)}`}
                className="p-2 rounded-lg hover:bg-neutral-light-grey dark:hover:bg-slate-800 transition-colors group"
                aria-label="Share via email"
              >
                <Mail className="h-5 w-5 text-neutral-charcoal/70 dark:text-white/80 group-hover:text-brand-bright-blue" aria-hidden="true" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="my-12 max-w-6xl mx-auto">
          <div className="relative w-full aspect-video bg-neutral-light-grey dark:bg-slate-800 rounded-xl overflow-hidden shadow-xl">
            <Image
              src={post.image}
              alt={post.title}
              fill
