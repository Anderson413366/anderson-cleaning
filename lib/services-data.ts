...
export const servicesData: Record<ServiceSlug, ServiceData> = {
  'office-cleaning': {
    ...
    testimonials: [
      {
        quote:
          'Anderson Cleaning Company has supported our Springfield HQ for six years. Their after-hours crews reset 80+ workstations nightly without disrupting confidential projects.',
        author: 'Mia Reynolds',
    ...
    metaTitle: 'Office Cleaning Services | Commercial Cleaning Western MA | Anderson Cleaning Company',
  ...
  'healthcare-cleaning': {
    ...
    metaTitle: 'Healthcare Cleaning Services | Commercial Cleaning Western MA | Anderson Cleaning Company',
  ...
  'janitorial-services': {
    ...
    overview: [
      'Property managers bring Anderson Cleaning Company in when they need consistent, reportable results across Class A towers, advanced manufacturing sites, or education campuses. We benchmark the current state of your facility, interview stakeholders, and observe traffic patterns on each floor. Using that data, we build a multi-frequency matrix that outlines daily, weekly, and monthly tasks by zone along with escalation protocols, supply ownership, and specialty projects.',
    ...
    metaTitle: 'Janitorial Services | Commercial Cleaning Western MA | Anderson Cleaning Company',
  ...
  'floor-care': {
    ...
    metaTitle: 'Floor Care Services | Commercial Cleaning Western MA | Anderson Cleaning Company',
  ...
  'window-cleaning': {
    ...
    metaTitle: 'Window Cleaning Services | Commercial Cleaning Western MA | Anderson Cleaning Company',
  ...
  'post-construction': {
    ...
    metaTitle: 'Post-Construction Cleaning | Commercial Cleaning Western MA | Anderson Cleaning Company',
  ...
  'emergency-cleaning': {
    ...
    metaTitle: 'Emergency Cleaning Services | Commercial Cleaning Western MA | Anderson Cleaning Company',
  ...
  'day-porter': {
    ...
    metaTitle: 'Day Porter Services | Commercial Cleaning Western MA | Anderson Cleaning Company',
