...
const FormCheckboxGroup: React.FC<FormCheckboxGroupProps> = (
  { label, namePrefix, options, values, onChange, error, translationKeyPrefix }
) => {
      ...
      <div className="mt-2 space-y-2">
        {options.map((optionKey) => (
          <div key={optionKey} className="flex items-center">
            ...
            />
            <label htmlFor={`${namePrefix}-${optionKey}`} className="ml-2 block text-sm text-gray-900 dark:text-gray-200">
