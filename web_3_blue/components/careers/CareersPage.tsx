...
import { generateCoverLetterSuggestion, generateInterviewTips, identifyStrengths } from '../../services/geminiService';
import { SparkType, InterviewPrepTip, SectionConfig, SectionError } from '../../types';
import { validateSectionData } from '../../utils/validation'; 
