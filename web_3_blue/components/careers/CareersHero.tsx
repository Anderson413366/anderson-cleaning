...
const CareersHero: React.FC<CareersHeroProps> = ({ onStartApplication }) => {
  ...
  return (
    <section id="careers-hero" className="py-16 md:py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-slate-800 dark:via-slate-900 dark:to-black text-white rounded-xl shadow-2xl overflow-hidden">
